...
export const HeroSection = () => {
  return (
    <section className="min-h-[max(900px,100vh)] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-gradient-to-r from-blue-100/30 to-purple-100/30 rounded-full blur-3xl" />
      <div className="absolute bottom-0 right-0 w-[600px] h-[400px] bg-gradient-to-l from-purple-100/20 to-blue-100/20 rounded-full blur-3xl" />
