        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Personally identifiable information, such as your name, company name, email address, and telephone number, and any other information you voluntarily provide to us when you inquire about or engage our Services. This includes information contained in project details, requirements, and communications.
              </p>
              <h3 className="text-xl font-medium mb-3">Billing Information</h3>
              <p className="mb-4">
                To process payments for our Services, we may collect billing details such as a billing address. We use a third-party payment processor to handle payment card information securely. We do not store your full credit card information on our servers.
              </p>
              <h3 className="text-xl font-medium mb-3">Derivative & Usage Data</h3>
              <p className="mb-4">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                ...
                <li>Create and manage your project, and communicate with you about it.</li>
                <li>Process payments and perform accounting.</li>
                <li>Respond to your comments, questions, and inquiries.</li>
                <li>Send you technical notices, updates, and marketing communications (where we have your consent).</li>
                <li>Improve our Site and Services for a better user experience.</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                <li><strong>With Service Providers:</strong> We may share your information with third-party vendors who perform services for us, such as payment processing, data analysis, cloud hosting, and email delivery.</li>
                <li><strong>With our Personnel and Contractors:</strong> Your information may be accessed by our employees and independent contractors for the purpose of providing the Services to you. Our personnel are bound by confidentiality obligations.</li>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Your information, including personal data, may be transferred to — and maintained on — computers located outside of your state, province, or country where the data protection laws may differ. As our development team includes contractors in Vietnam, information related to your project may be accessed from that location.
              </p>
              <p className="mb-4">
                We take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy. We rely on legal mechanisms such as Standard Contractual Clauses to ensure adequate protection for data transfers.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-2">Email: privacy@lamgig.com</p>
